...
class AuthKeys:
    ...
    def generate_token(self, *, scope: str, **token_data):
        token = jwt.encode({"scope": scope, **token_data}, cast(Any, self.priv), algorithm="RS256")
    ...
    def generate_safekeeper_token(self):
...
class Safekeeper:
    ...
    def append_logical_message(
        ...
        token = self.env.auth_keys.generate_tenant_token(tenant_id.id.hex)
